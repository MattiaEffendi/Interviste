    ...
    <div class="middle">
        <div class="inner">
            <div class="outer">
                ...
                <font face="Verdana"><b>ArgoBot <?php echo $version; ?> | by Doppio</b><br />Bot is working!</font>
...
function getChat($chatID)
{
    ...
    $r = new HttpRequest("post", "https://api.telegram.org/$api/getChat", $args);
    return $r->getResponse();
}
...
/*$plugins = array(
 6   "usersManager.php" => true
);*/

require "code.php";
include "Plugins/usersManager.php";
/*echo "Plugins included:";
foreach($plugins as $plugin => $active){
    if($active) include "Plugins/$plugin";
    echo "<br>- $plugin";
